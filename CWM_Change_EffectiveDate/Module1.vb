...
Module Module1
    ...
    Public edate As String = "2017/12/12"
    ...
    'Public con As New SqlConnection("Data Source=SQL5016.Smarterasp.net;Initial Catalog=DB_9AAA2F_SFAHeadoffice;User Id=DB_9AAA2F_SFAHeadoffice_admin;Password=dbcl1234;")
    ...
    Function GetDataACC(ByVal p1 As String, ByVal p2 As String, ByVal p3 As String, ByVal p4 As String, ByVal p5 As String, ByVal pn1 As String, ByVal pn2 As String, ByVal pn3 As String, ByVal pn4 As String, ByVal pn5 As String, ByVal sql As String, ByVal Conne As OleDbConnection) As System.Data.DataSet
        ' MsgBox(sql)ol
        Dim queryString As String = sql
        Dim dbCommand As System.Data.IDbCommand = New System.Data.OleDb.OleDbCommand
        dbCommand.CommandText = queryString
        dbCommand.Connection = Conne
    ...
    Function ComboSelectedValue(ByVal sql As String, ByVal select_val As String)
        Dim ID As String = ""
        Dim ds As DataSet
        ds = GetDataSQL("", "p2", "p3", "p4", "p5", "@id", "pn2", "pn3", "pn4", "pn5", sql)
